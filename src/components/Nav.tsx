      ...
      <div className="max-w-2xl mx-auto w-full px-6 flex items-center justify-between py-4 text-sm">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="font-mono text-[10px] sm:text-xs uppercase tracking-widest bg-[#85c1dc] text-[#4c4f69] px-2 sm:px-2.5 py-1 rounded-[4px] font-bold cursor-pointer transition-colors hover:bg-ctp-text hover:text-[#dce0e8] dark:text-ctp-crust dark:hover:text-ctp-crust whitespace-nowrap"
          >
            Get in touch
          </button>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="hidden sm:block font-mono text-[10px] sm:text-xs uppercase tracking-widest bg-ctp-peach text-[#4c4f69] px-2 sm:px-2.5 py-1 rounded-[4px] font-bold transition-colors hover:bg-ctp-text hover:text-[#dce0e8] dark:text-ctp-crust dark:hover:text-ctp-crust whitespace-nowrap"
          >
            Resume
          </a>
        </div>
